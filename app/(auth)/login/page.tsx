  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white p-10 rounded-3xl w-full max-w-md shadow">
        ...
        <input type="password" placeholder="Senha" className="w-full p-4 border rounded-xl mb-6" value={password} onChange={e => setPassword(e.target.value)} />
        <button onClick={handleLogin} disabled={loading} className="w-full py-4 bg-indigo-600 text-white rounded-xl text-lg">
