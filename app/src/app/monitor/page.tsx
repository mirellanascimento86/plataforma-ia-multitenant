...
export default function Monitor() {
  ...
  async function sendAsHuman(orderId: string, content: string) {
    ...
    // Implementar chamada à API de envio
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-1 bg-white rounded-lg shadow-md p-4 h-[80vh] overflow-y-auto">
            <h2 className="font-semibold mb-4">Atendimentos Ativos</h2>
          ...
          {/* Conversa */}
          <div className="col-span-2 bg-white rounded-lg shadow-md p-4 h-[80vh] flex flex-col">
            {selectedOrder ? (
              <>
                ...
                <div className="border-t pt-4">
                  <form
                    onSubmit={(e) => {
                      ...
                      if (input.value.trim()) {
                        sendAsHuman(selectedOrder.id, input.value);
                        input.value = '';
                      }
                    }}
